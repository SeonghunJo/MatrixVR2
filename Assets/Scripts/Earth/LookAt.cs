	...
	void Update () {
        ...
        if (Input.GetKey(KeyCode.UpArrow))
        {
            if (270 < transform.rotation.eulerAngles.x || transform.rotation.eulerAngles.x + 10.0f < 90)
                transform.RotateAround(target.GetComponent<Collider>().bounds.center, new Vector3(1.0f, 0, 0.0f), 1.0f);
        }
		...
		{
            if (270 < transform.rotation.eulerAngles.x || transform.rotation.eulerAngles.x + 10.0f < 90)
                transform.RotateAround(target.GetComponent<Collider>().bounds.center, new Vector3(1.0f, 0, 0.0f), 0.8f);
		}
